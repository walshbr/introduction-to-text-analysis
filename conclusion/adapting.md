...
* **The GitBook editor and system are changing rapidly, and we make no guarantees that these steps are updated. As of this writing, they were, but let us know by filing an issue on our [GitHub repository](https://github.com/bmw9t/introduction-to-text-analysis/issues) if you find a problem.**
