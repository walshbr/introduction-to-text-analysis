...
![zotero download](/assets/data-cleaning/zotero-download.png)
...
![zotero standalone screen](/assets/data-cleaning/zotero-standalone.png)
...
![adding a book citation](/assets/data-cleaning/zotero-add-citation.png)
...
![adding crone citation](/assets/data-cleaning/zotero-editing-pane.png)
...
![magic wand ISBN input](/assets/data-cleaning/zotero-magic-wand.png)
...
![input by isbn](/assets/data-cleaning/zotero-input-by-isbn.png)
...
![zotero download from chrome](/assets/data-cleaning/zotero-download-from-chrome.png)
...
![zotero input from web](/assets/data-cleaning/zotero-input-from-web.png)
...
![zotero menu in word](/assets/data-cleaning/zotero-menu-in-word.png)
...
![zotero selection citation style](/assets/data-cleaning/zotero-select-citation-style.png)
...
![zotero searching for citation](/assets/data-cleaning/zotero-searching-for-citation.png)
...
![zotero give page numbers to citation](/assets/data-cleaning/zotero-give-page-numbers-to-citation.png)
...
* 'cmd + down arrow' will bring up additional options like adding page numbers once you have a citation selected in the add citation input field.
  !\[zotero example citation\[\(\/assets\/zotero\-example\-citation.png\)
...
![zotero text with bibliography](/assets/data-cleaning/zotero-document-with-bibliography.png)
