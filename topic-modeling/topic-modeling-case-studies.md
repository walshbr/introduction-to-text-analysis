...
These are all backgrounds and framing contexts for **topic modeling**, a machine learning technique that allows you to discover the topics that construct a text. 
